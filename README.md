...
- [`07-taste-skill-fact-check/`](07-taste-skill-fact-check/) — "I Fact-Checked 'Taste Skill,' the Viral Anti-Slop AI Coding Framework." The real benchmark harness (15 generations, 5 configurations x 3 briefs) used to test the viral `taste-skill` Claude Code skill against its own 50-item ban list, plus the 129-token lean directive we benchmarked against its 21,998-token system prompt.
